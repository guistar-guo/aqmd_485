...
void servos_init(void)
{
	...
	servos1_set_angle(INIT_ANGLE);
	servos2_set_angle(INIT_ANGLE);
	servos3_set_angle(INIT_ANGLE);
	servos4_set_angle(INIT_ANGLE);
	servos5_set_angle(INIT_ANGLE);
}

void servos_set_angle(float angle){
	servos1_set_angle(angle);
	servos2_set_angle(angle);
	servos3_set_angle(angle);
	servos4_set_angle(angle);
	servos5_set_angle(angle);
}
